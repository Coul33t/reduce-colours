...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_number_of_merged_colours = QtWidgets.QLabel(self.centralwidget)
        self.label_number_of_merged_colours.setGeometry(QtCore.QRect(390, 520, 141, 16))
        self.label_number_of_merged_colours.setText("")
        self.label_number_of_merged_colours.setObjectName("label_number_of_merged_colours")
